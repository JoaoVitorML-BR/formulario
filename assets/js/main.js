class ValidaFormulario {
    ...
    camposSaoValidos() {
      ...
      for(let campo of this.formulario.querySelectorAll('.validar')) {// here we're get all form with class validar in html
        const label = campo.previousElementSibling.innerText; // get the current field to send the message that cannot be blank
